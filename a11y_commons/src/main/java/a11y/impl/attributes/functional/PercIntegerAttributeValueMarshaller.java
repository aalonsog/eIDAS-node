package a11y.impl.attributes.studies;
...
import a11y.api.attributes.Definitions;
import eu.eidas.auth.commons.attribute.AttributeValue;
import eu.eidas.auth.commons.attribute.AttributeValueMarshaller;
import eu.eidas.auth.commons.attribute.AttributeValueMarshallingException;
import eu.eidas.auth.commons.attribute.impl.IntegerAttributeValue;

public class PercIntegerAttributeValueMarshaller implements AttributeValueMarshaller<Integer> {
    ...
    public String marshal(@Nonnull AttributeValue<Integer> value) throws AttributeValueMarshallingException {
    	...
    	if (value.getValue() < 0 || value.getValue() > 100)
    		throw new AttributeValueMarshallingException(Definitions.VISION_NAME + " has a not valid value" + value.getValue().toString());
    ...
    public AttributeValue<Integer> unmarshal(@Nonnull String value, boolean isNonLatinScriptAlternateVersion)
        ...
        try {
    		...
    		if (!matcher.matches())
    			throw new AttributeValueMarshallingException(Definitions.VISION_NAME + " has a not valid value" + value);
